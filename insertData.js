...
pool.query(
    `INSERT INTO UserJanetJohn2021 
                 (ID, COUNTRY, BUSINESS_NAME, FIRST_NAME, LAST_NAME, Email, PASSWORD, PHONE, SKILL, DESCRIPTION, CATEGORY, CREATED_DT)
                 VALUES 
                 ('1', 'Nigeria', 'Ugo Foods Ltd', 'Ugo', 'Parker' , 'ugoparker27@gmail.com', 'ugo2020', '08182223345', 'True', 'my business', 'restaurant', '2021-02-21'),
                 ('2', 'Brazil', 'Jane Travels', 'Janet', 'John' , 'Janetjohn@gmail.com', 'Janet23', '09023445553', 'False', 'Delivery service', 'Logistics', '2021-01-21'),
                 ('3', 'Ghana', 'George Paints', 'George', 'George', 'Georgesketch23@gmail.com', 'george22', '09036522526', 'True', 'Art Business', 'Art', '2021-01-21')
                 `,
    (err, res) => {
      if(err) {
